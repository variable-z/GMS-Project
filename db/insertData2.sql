-- Insert data into User table (adding user_id for both OnlineCustomer and WalkInCustomer)
...
-- Insert data into MembershipCard table (user_id references valid OnlineCustomer IDs)
